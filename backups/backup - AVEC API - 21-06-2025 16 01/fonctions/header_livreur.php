...
// Rediriger si non authentifié ou non livreur
...
<header class="admin-navbar">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="/site_web/features/public/espaces/livreur/index.php">
        <strong>EcoDeli Livreur</strong>
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#livreurNavbar" aria-controls="livreurNavbar" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      
      <div class="collapse navbar-collapse" id="livreurNavbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/site_web/features/public/espaces/livreur/index.php">
              <svg class="bi" width="16" height="16"><use xlink:href="#speedometer2"/></svg>
              Tableau de bord
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/site_web/features/public/espaces/livreur/mes_livraisons.php">
              <svg class="bi" width="16" height="16"><use xlink:href="#truck"/></svg>
              Mes livraisons
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/site_web/features/public/espaces/livreur/annonces_dispo.php">
            ...
            <button class="btn btn-sm btn-outline-light d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <?php else: ?>
                <span class="rounded-circle bg-light text-primary me-2 d-inline-flex align-items-center justify-content-center" style="width: 24px; height: 24px; font-size: 12px;">
                  <?php echo substr(htmlspecialchars($_SESSION['utilisateur']['nom'] ?? 'L'), 0, 1); ?>
                </span>
              <?php endif; ?>
              <span class="d-none d-md-inline"><?php echo htmlspecialchars($_SESSION['utilisateur']['nom'] ?? 'Livreur'); ?></span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end">
              <li><h6 class="dropdown-header">Mon compte</h6></li>
              <li>
                <a class="dropdown-item" href="/site_web/features/public/espaces/livreur/profile_livreur.php">
