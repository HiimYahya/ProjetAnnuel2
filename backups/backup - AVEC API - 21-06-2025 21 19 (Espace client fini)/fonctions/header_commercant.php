...
// Rediriger si non authentifié ou non commerçant
if (!isset($_SESSION['utilisateur']) || $_SESSION['utilisateur']['role'] !== 'commercant') {
...
<header class="admin-navbar">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="/site_web/features/public/espaces/commercant/index.php">
        <strong>EcoDeli Commerçant</strong>
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#commercantNavbar" aria-controls="commercantNavbar" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      
      <div class="collapse navbar-collapse" id="commercantNavbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/site_web/features/public/espaces/commercant/index.php">
              <svg class="bi" width="16" height="16"><use xlink:href="#speedometer2"/></svg>
              Tableau de bord
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/site_web/features/public/espaces/commercant/mon_espace2.php">
              <svg class="bi" width="16" height="16"><use xlink:href="#shop"/></svg>
              Mon espace 2
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/site_web/features/public/espaces/commercant/mon_espace3.php">
              <svg class="bi" width="16" height="16"><use xlink:href="#package"/></svg>
              Mon espace 3
            </a>
          </li>
        </ul>
        ...
        <div class="d-flex align-items-center">
          <div class="dropdown me-3">
            <button class="btn btn-sm btn-outline-light d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <?php endif; ?>
              <span class="d-none d-md-inline"><?php echo htmlspecialchars($_SESSION['utilisateur']['nom'] ?? 'Commerçant'); ?></span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end">
              <li><h6 class="dropdown-header">Mon compte</h6></li>
              <li>
                <a class="dropdown-item" href="/site_web/features/public/espaces/commercant/profile_commercant.php">
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="moon-stars-fill" viewBox="0 0 16 16">
    ...
    <path d="M10.794 3.148a.217.217 0 0 1 .412 0l.387 1.162c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.734 1.734 0 0 0-1.097 1.097l-.387 1.162a.217.217 0 0 1-.412 0l-.387-1.162A1.734 1.734 0 0 0 9.31 6.593l-1.162-.387a.217.217 0 0 1 0-.412l1.162-.387a1.734 1.734 0 0 0 1.097-1.097l.387-1.162zM13.863.099a.145.145 0 0 1 .274 0l.258.774c.115.346.386.617.732.732l.774.258a.145.145 0 0 1 0 .274l-.774.258a1.156 1.156 0 0 0-.732.732l-.258.774a.145.145 0 0 1-.274 0l-.258-.774a1.156 1.156 0 0 0-.732-.732l-.774-.258a.145.145 0 0 1 0-.274l.774-.258c.346-.115.617-.386.732-.732L13.863.1z"/>
  </symbol>
