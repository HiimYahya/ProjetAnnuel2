...
// Afficher les enregistrements d'une table avec une limite et un lien "Afficher tout"
function afficherAvecLimite($conn, $table, $colonnes, $limite, $ordre = 'ASC') {
    ...
    $colonnes = preg_replace('/[^a-zA-Z0-9_, ]/', '', $colonnes);
    ...
    // Récupérer les noms des colonnes et exclure "id"
    $columns = explode(',', str_replace(' ', '', $colonnes));
    $columns = array_filter($columns, function ($col) {
        return strtolower($col) !== 'id'; // Exclure la colonne "id"
    });

    foreach ($columns as $col) {
        echo "<th>" . ucfirst($col) . "</th>";
    }
    echo "<th>Actions</th>"; // Colonne pour les liens de modification
    echo "</tr></thead><tbody>";
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        foreach ($columns as $col) {
            if ($col === 'id_client') {
                echo "<td><a href='clients.php?id={$row[$col]}' class='btn btn-link'>{$row[$col]}</a></td>";
            } elseif ($col === 'id_livreur') {
                echo "<td><a href='livreurs.php?id={$row[$col]}' class='btn btn-link'>{$row[$col]}</a></td>";
            } elseif ($col === 'statut') {
                $status = strtolower($row[$col]);
                if (in_array($status, ['terminé', 'effectué', 'livrée', 'disponible'])) {
                    $icon = "🟢";
                } elseif (in_array($status, ['en cours', 'en attente', 'en livraison'])) {
                    $icon = "🟠";
                } else {
                    $icon = "🔴";
                }
        ...
        echo "<td><a href='modifier.php?table=$table&id={$row['id']}' class='btn btn-primary btn-sm'>Détails</a></td>";
        echo "</tr>";
    }
    echo "</tbody></table>";

    // Lien pour afficher tout
    $page = "backend/" . $table . ".php";
    echo "<a href='$page' class='btn btn-secondary'>Afficher tout</a>";
}
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Backend : Vue d'ensemble</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#collection"/></svg>
        </div>
        <h3 class="fs-2 text-body-emphasis">Livreurs</h3>
      ...
      <div class="feature col">
        ...
        <h3 class="fs-2 text-body-emphasis">Livraisons</h3>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-2 text-body-emphasis">Prestataires</h3>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-2 text-body-emphasis">Prestations</h3>
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fs-2 text-body-emphasis">Paiements</h3>
  ...
  <div class="container px-4 py-5" id="custom-cards">
    <h2 class="pb-2 border-bottom">Factures</h2>

    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('unsplash-photo-1.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Mochemi</h3>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('unsplash-photo-2.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Harissa</h3>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('unsplash-photo-3.jpg');">
          <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Faker</h3>
        </div>
      </div>
    </div>
  </div>
...
<div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <p class="col-md-4 mb-0 text-body-secondary">&copy; Mentalité Kaizen, Inc</p>
